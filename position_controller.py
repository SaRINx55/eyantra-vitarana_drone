...
class Edrone():
	...
	def pos_control(self):
		...
		if self.latitude < 19.0000251704:
		...
		if self.latitude >= 19.0000451004 :
		#	rospy.sleep(0.003)
			...
			self.errorD = (self.setpoint - self.altitude)*10
			#self.Iterm[0] = (self.Iterm[0] + self.errorD)*self.Ki[0] 
			#self.z_error = self.Kp[0]*self.errorD + self.Kd[0]*(self.errorD - self.prev_error[2]) +self.Iterm[0]
			#self.prev_error[2] = self.errorD
